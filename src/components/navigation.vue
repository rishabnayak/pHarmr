<template>
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
      <!-- <h5 class="my-0 mr-md-auto font-weight-normal"><router-link to="/">pHarmr</router-link></h5> -->
      <a class="navbar-brand mr-0 mr-md-2" href="/"><img class="d-block" width="100" height="50" src="@/assets/pHarmr_logo.png" />
      </a>
